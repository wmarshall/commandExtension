...
public abstract class Command implements NamedSendable {
	 ...
	 *
	 * @param timeout
	 *            the time (in seconds) before this command "times out"
	 * @throws IllegalArgumentException
	 *             if given a negative timeout
	 ...
	 *            the time (in seconds) before this command "times out"
	 * @throws IllegalArgumentException
	 *             if given a negative timeout or name was null.
	 * @see Command#isTimedOut() isTimedOut()
	 */
	 ...
	 *
	 * @param subsystem
	 *            the {@link Subsystem} required
	 * @throws IllegalArgumentException
	 *             if subsystem is null
	 * @throws IllegalUseOfCommandException
	 *             if this command has started before or if it has been given to
	 *             a {@link CommandGroup}
	 * @see Subsystem
	 */
	 ...
	 * {@link Command#interrupted() interrupted()} or {@link Command#end()
	 * end()}.
	 */
	 ...
	 * immediately. We recommend using {@link InstantCommand} for this.
	 *
	 ...
	 *         {@link Subsystem Subsystems}) of this command
	 */
	synchronized Stream<Subsystem> getRequirementsStream() {
		return m_requirements.stream();
	}

	synchronized Set<Subsystem> getRequirementsSet() {
		return new HashSet<>(m_requirements);
	}
	 ...
	 *
	 * @param message
	 *            the message to say (it is appended by a default message)
	 */
	 ...
	 *            the parent
	 * @throws IllegalUseOfCommandException
	 *             if this {@link Command} already is already in a group
	 */
	 ...
	 * {@link ConditionalCommand} so cancelling the chosen command works
	 * properly in {@link CommandGroup}.
	 */
	 ...
	 *
	 * @param run
	 *            whether or not this command should run when the robot is
	 *            disabled
	 */
